...
public class ElecHisActivity extends BasedActivity implements OnChartValueSelectedListener, View.OnClickListener {
...
//                    mChartDes.setText(mYear + "年" + mMonth + "月" + mDay + getString(R.string.ele_his_yaer_des));
                    mChartDes.setText(String.format(getString(R.string.ele_his_day_des),mYear+"",mMonth+"",mDay+""));
                }
...
//                    mChartDes.setText(mYear + "年各月份用电量柱形图");
    ...
    protected void onResume() {
        super.onResume();
        getData(getIntent().getStringExtra("room_id"), time.getText().toString());
    }
...
//                    ((ViewGroup) ((ViewGroup) (datePicker.getChildAt(0))).getChildAt(0)).getChildAt(2).setVisibility(View.GONE);
    ...
    private CompatDatePickerDialog.OnDateSetListener mDateSetListener =
            new CompatDatePickerDialog.OnDateSetListener() {
                public void onDateSet(DatePicker view, int year, int monthOfYear,
                    ...
                    upDateDes();
                    getData(room_id, time.getText().toString());
    ...
    private void getData(String room_id, String date) {
        LogUtil.i(room_id);
        showLoadingState();
        addSubscription(RetrofitHelper.getApi().getAmmeter3Data(room_id, date), new BaseSubscriber<Ameter3Entity>(this) {
            @Override
