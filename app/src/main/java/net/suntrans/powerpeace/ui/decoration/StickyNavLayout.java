...
//        Log.e(TAG, "onNestedPreScroll");
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed) {
        ...
        if (target instanceof SwipeRefreshLayout && velocityY < 0) {
            final SwipeRefreshLayout swipeRefreshLayout = (SwipeRefreshLayout) target;
            final RecyclerView recyclerView = (RecyclerView) swipeRefreshLayout.findViewById(R.id.recyclerView);
