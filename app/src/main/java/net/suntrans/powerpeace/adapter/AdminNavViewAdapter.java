...
public class AdminNavViewAdapter extends BaseQuickAdapter<NavViewItem,BaseViewHolder>{


    public AdminNavViewAdapter(@LayoutRes int layoutResId, @Nullable List<NavViewItem> data) {
    ...
    public static List<NavViewItem> getItems(){
        ...
        NavViewItem item7 = new NavViewItem(R.drawable.ic_info_nav,"异常提示");
