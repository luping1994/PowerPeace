...
import net.suntrans.powerpeace.databinding.ActivityBuildingMainBinding;
...
import net.suntrans.powerpeace.ui.fragment.BuildingManagerFragment;
 ...
 * 楼栋管理员
 */
public class BuildingManagerMainActivity extends BasedActivity implements View.OnClickListener
        , BasedFragment.OnFragmentInteractionListener {

    private ActivityBuildingMainBinding binding;
...
//        bindService(intent, connection, ContextWrapper.BIND_AUTO_CREATE);
    ...
    private void init() {
        ...
        BuildingManagerFragment floorManagerFragment = new BuildingManagerFragment();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case START_MSG_ACTIVITY:
                    intent.setClass(BuildingManagerMainActivity.this, MsgCenterActivity.class);
                    break;
                case START_SETTING_ACTIVITY:
                    intent.setClass(BuildingManagerMainActivity.this, SettingActivity.class);
                    break;
                case START_HELP_ACTIVITY:
                    intent.setClass(BuildingManagerMainActivity.this, HelpActivity.class);
                    break;
                case START_ABOUT_ACTIVITY:
                    intent.setClass(BuildingManagerMainActivity.this, AboutActivity.class);
                    break;
                ...
                case START_YICHANG_ACTIVITY:
                    intent.setClass(BuildingManagerMainActivity.this, YichangActivity.class);
                    break;
                case START_INTERNET_ACTIVITY:
                    intent.setAction("android.intent.action.VIEW");
                    Uri content_url = Uri.parse("https://www.suntrans.net");
